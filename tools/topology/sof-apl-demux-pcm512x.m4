...
PIPELINE_ADD(sof/pipe-volume-playback-nopcm.m4,
	5, 2, s32le,
	48, 1000, 0, 0, PIPELINE_PLAYBACK_SCHED_COMP_1)
...
SectionGraph."PIPE_NAME" {
	...
	lines [
		# mux to capture
		dapm(PIPELINE_SOURCE_5, PIPELINE_MUXDEMUX_1)
	]
}
...
PCM_CAPTURE_ADD(Port1, 4, PIPELINE_PCM_6)
